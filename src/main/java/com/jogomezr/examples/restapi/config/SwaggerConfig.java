package com.jogomezr.examples.restapi.config;
...
public class SwaggerConfig extends DelegatingWebMvcConfiguration {
	...
	private static final String SWAGGER_BASE_PACKAGE = "com.jogomezr.examples.restapi";
	...
	private ApiInfo getMetadata() {
		...
		return new ApiInfoBuilder()
				.title("REST API example with Spring Boot")
				.description("Basic structure of a REST API implemented with Spring Boot")
				.version("v2")
				.build();
